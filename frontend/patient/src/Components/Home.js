...
const Home = () => {
    ...
    return (
        <div className="dark:text-white-900">
            ...
            <p className='text-xl underline font-bold  text-center mt-5 mb-5'>
            ...
            <div className='grid grid-cols-2 place-items-center'>
                {temp2.map((e, i) =>
                    <div className='border-metal shadow-md rounded-lg overflow-hidden max-w-[90%] select-none grid grid-cols-2'>
                        ...
                        <div className='m-4'>
                            ...
                            <p className='text-justify'> Just fill out the online pledge form and we will send you a donor card with your unique government registration number. All pledges are registered with the National Organ & Tissue Transplant Organisation (NOTTO).</p>
                        </div>
                    </div>
                ...
                {temp3.map((e, i) =>
                    <div className='border-metal shadow-md rounded-lg overflow-hidden max-w-[90%] select-none grid grid-cols-2'>
                        <div><img src={e.img} draggable={false} width="100%" alt="" /></div>
                        <div className='m-4'>
                            <h1 className='font-bold text-lg text-midnight dark:text-white-900'>{i + 2}-{e.title}</h1>
                            <p className='text-justify'>The living donor will need to remain under medical care for a few days or weeks after organ retrieval until she/he is fit to go home. </p>
                        </div>
                    </div>
                ...
                {temp4.map((e, i) =>
                    <div className='border-metal shadow-md rounded-lg overflow-hidden max-w-[90%] select-none grid grid-cols-2'>
                        <div><img src={e.img} draggable={false} width="100%" alt="" /></div>
                        <div className='m-4'>
                            <h1 className='font-bold text-lg text-midnight dark:text-white-900'>{i + 3}-{e.title}</h1>
                            <p className='text-justify'>You can donate some organs while you are alive, and this is called living organ donation. However, most organ and tissue donations come from people who have died.</p>
                        </div>
                    </div>
                ...
                {temp5.map((e, i) =>
                    <div className='border-metal shadow-md rounded-lg overflow-hidden max-w-[90%] select-none grid grid-cols-2'>
                        <div><img src={e.img} draggable={false} width="100%" alt="" /></div>
                        <div className='m-4'>
                            <h1 className='font-bold text-lg text-midnight dark:text-white-900'>{i + 4}-{e.title}</h1>
                            <p className='text-justify'> Organ Donation is donating a donor's organs like heart, liver, kidneys, intestines, lungs, and pancreas, after the donor dies, for the purpose of transplanting them into another person who is in need of an organ.</p>
                        </div>
                    </div>
            ...
            <br />
            <div className='w-[100%] bg-metal text-white-900 h-[12vh]  text-4xl text-center font-bold'>
                <code>Ikshana+ {new Date().getFullYear()} || Made with ❤️ By Team Hacktivists</code>
            </div>
        </div>
    )
}
